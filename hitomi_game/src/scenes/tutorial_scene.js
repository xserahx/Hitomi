...
function preload_tutorial_scene(scene) {
    tutorial_bg = PP.assets.image.load(scene, "assets/images/house/house_background.png", 1280, 920);
...
function create_tutorial_scene(scene) {
    ...
    // === BAMBINO ===
    const baby = PP.shapes.rectangle_add(scene, 135, 777, 40, 40, "0xffffff", 1);
